...
always resolves to the latest version (CC BY 4.0). Version v2.1 carries 395 hash-verified
payload files, 2,944,952,330 bytes uncompressed, distributed as a deterministic gzip
archive of 2,654,423,871 bytes with a SHA-256 sidecar and an `archive_info.json` record.
It contains:
